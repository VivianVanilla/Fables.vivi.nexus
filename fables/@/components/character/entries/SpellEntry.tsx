        ...
        <Modal onClose={() => setEditing(false)}>
          <div className="bg-zinc-900 border border-white/15 rounded-2xl shadow-2xl w-[min(560px,calc(100vw-2rem))] max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div className="overflow-y-auto flex-1 p-5 flex flex-col gap-4">
              ...
              {/* Cast setup (expend a slot / activate a Form / grant conditions
                  on cast) lives entirely in Automation now — a per-spell button
                  and config section here didn't hold up on mobile. */}
              <p className="text-[10px] text-white/25 italic">Want a Cast button for this spell? Set it up from Automation.</p>
            </div>
