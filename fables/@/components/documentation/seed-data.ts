  ...
  item: [
    ...
    { id:"club", name:"Club", description:"Simple Melee Weapon · 1 sp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"bludgeoning", properties:"Light", weight:2,
             description:"Simple Melee Weapon · 1 sp" }},
    { id:"dagger", name:"Dagger", description:"Simple Melee Weapon · 2 gp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"piercing", properties:"Finesse, light, thrown (range 20/60)", weight:1,
             description:"Simple Melee Weapon · 2 gp" }},
    { id:"greatclub", name:"Greatclub", description:"Simple Melee Weapon · 2 sp",
      data:{ item_type:"weapon", damage:"1d8", damage_type:"bludgeoning", properties:"Two-handed", weight:10,
             description:"Simple Melee Weapon · 2 sp" }},
    { id:"handaxe", name:"Handaxe", description:"Simple Melee Weapon · 5 gp",
      data:{ item_type:"weapon", damage:"1d6", damage_type:"slashing", properties:"Light, thrown (range 20/60)", weight:2,
             description:"Simple Melee Weapon · 5 gp" }},
    { id:"javelin", name:"Javelin", description:"Simple Melee Weapon · 5 sp",
      data:{ item_type:"weapon", damage:"1d6", damage_type:"piercing", properties:"Thrown (range 30/120)", weight:2,
             description:"Simple Melee Weapon · 5 sp" }},
    ...
    { id:"sickle", name:"Sickle", description:"Simple Melee Weapon · 1 gp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"slashing", properties:"Light", weight:2,
             description:"Simple Melee Weapon · 1 gp" }},
    ...
    { id:"crossbow-light", name:"Crossbow, light", description:"Simple Ranged Weapon · 25 gp",
      data:{ item_type:"weapon", damage:"1d8", damage_type:"piercing", properties:"Ammunition (range 80/320), loading, two-handed", weight:5,
             description:"Simple Ranged Weapon · 25 gp" }},
    { id:"dart", name:"Dart", description:"Simple Ranged Weapon · 5 cp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"piercing", properties:"Finesse, thrown (range 20/60)", weight:0.25,
             description:"Simple Ranged Weapon · 5 cp" }},
    ...
    { id:"sling", name:"Sling", description:"Simple Ranged Weapon · 1 sp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"bludgeoning", properties:"Ammunition (range 30/120)",
             description:"Simple Ranged Weapon · 1 sp" }},
    { id:"battleaxe", name:"Battleaxe", description:"Martial Melee Weapon · 10 gp",
      data:{ item_type:"weapon", damage:"1d8", damage_type:"slashing", properties:"Versatile (1d10)", weight:4,
             description:"Martial Melee Weapon · 10 gp" }},
    ...
    { id:"glaive", name:"Glaive", description:"Martial Melee Weapon · 20 gp",
      data:{ item_type:"weapon", damage:"1d10", damage_type:"slashing", properties:"Heavy, reach, two-handed", weight:6,
             description:"Martial Melee Weapon · 20 gp" }},
    { id:"greataxe", name:"Greataxe", description:"Martial Melee Weapon · 30 gp",
      data:{ item_type:"weapon", damage:"1d12", damage_type:"slashing", properties:"Heavy, two-handed", weight:7,
             description:"Martial Melee Weapon · 30 gp" }},
    { id:"greatsword", name:"Greatsword", description:"Martial Melee Weapon · 50 gp",
      data:{ item_type:"weapon", damage:"2d6", damage_type:"slashing", properties:"Heavy, two-handed", weight:6,
             description:"Martial Melee Weapon · 50 gp" }},
    ...
    { id:"longsword", name:"Longsword", description:"Martial Melee Weapon · 15 gp",
      data:{ item_type:"weapon", damage:"1d8", damage_type:"slashing", properties:"Versatile (1d10)", weight:3,
             description:"Martial Melee Weapon · 15 gp" }},
    ...
    { id:"pike", name:"Pike", description:"Martial Melee Weapon · 5 gp",
      data:{ item_type:"weapon", damage:"1d10", damage_type:"piercing", properties:"Heavy, reach, two-handed", weight:18,
             description:"Martial Melee Weapon · 5 gp" }},
    { id:"rapier", name:"Rapier", description:"Martial Melee Weapon · 25 gp",
      data:{ item_type:"weapon", damage:"1d8", damage_type:"piercing", properties:"Finesse", weight:2,
             description:"Martial Melee Weapon · 25 gp" }},
    ...
    { id:"whip", name:"Whip", description:"Martial Melee Weapon · 2 gp",
      data:{ item_type:"weapon", damage:"1d4", damage_type:"slashing", properties:"Finesse, reach", weight:3,
             description:"Martial Melee Weapon · 2 gp" }},
    { id:"blowgun", name:"Blowgun", description:"Martial Ranged Weapon · 10 gp",
      data:{ item_type:"weapon", damage:"1", damage_type:"piercing", properties:"Ammunition (range 25/100), loading", weight:1,
             description:"Martial Ranged Weapon · 10 gp" }},
    { id:"crossbow-hand", name:"Crossbow, hand", description:"Martial Ranged Weapon · 75 gp",
      data:{ item_type:"weapon", damage:"1d6", damage_type:"piercing", properties:"Ammunition (range 30/120), light, loading", weight:3,
             description:"Martial Ranged Weapon · 75 gp" }},
    { id:"crossbow-heavy", name:"Crossbow, heavy", description:"Martial Ranged Weapon · 50 gp",
      data:{ item_type:"weapon", damage:"1d10", damage_type:"piercing", properties:"Ammunition (range 100/400), heavy, loading, two-handed", weight:18,
             description:"Martial Ranged Weapon · 50 gp" }},
    ...
    { id:"net", name:"Net", description:"Martial Ranged Weapon · 1 gp",
      data:{ item_type:"weapon", properties:"Special, thrown (range 5/15)", weight:3,
             description:"Martial Ranged Weapon · 1 gp" }},
  ],
}
